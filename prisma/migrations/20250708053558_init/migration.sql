...
CREATE TABLE "group" (
    ...
    "registeredPlaces" INTEGER NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "academic_schedule_semester_key" ON "academic_schedule"("semester");

-- CreateIndex
CREATE UNIQUE INDEX "classroom_location_key" ON "classroom"("location");

-- CreateIndex
CREATE UNIQUE INDEX "professor_identification_key" ON "professor"("identification");
