...
def check_prisma_status():
    ...
    if os.path.exists('prisma/migrations'):
        ...
        migration_dirs = [d for d in migrations if os.path.isdir(f'prisma/migrations/{d}') and d != '__pycache__']
...
def main():
    ...
    if all_good:
        ...
        print("\nCommon solutions:")
        print("   1. Restart containers: docker-compose -f docker-compose.prod.yml restart")
