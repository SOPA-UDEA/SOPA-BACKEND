...
def verify_tables():
    ...
    try:
        ...
        expected_tables = [
            'academic_program', 'academic_schedule', 'classroom', 'classroom_x_group',
            'department', 'faculty', 'group', 'group_x_professor', 'mirror_group',
            'modality', 'pensum', 'prerequirement', 'professor', 'subject',
            'academic_schedule_pensum', 'message_classroom_group', 'message_type'
        ]
...
if __name__ == "__main__":
    ...
    if verify_tables():
        ...
        print("❌ Database schema incomplete. Please run the migration SQL in DBeaver first.")
