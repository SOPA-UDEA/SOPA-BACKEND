...
async def get_academic_schedule_by_semester(academic_schedule_name):
    return await database.academic_schedule.find_first(where={"semester": academic_schedule_name})